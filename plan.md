...
- Additional sounds/states ideas not in the current Fenix spec, but will need sound pack support e.g.
  ...
  - Reached TOC Cruise altitude announcement, for service etc other than CruiseElapsed, plus TOD (like CruiseElapsed)
